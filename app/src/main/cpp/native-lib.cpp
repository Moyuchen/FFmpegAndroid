...
Java_com_moyuchen_ffmpegandroid_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_moyuchen_ffmpegandroid_FFmpeg_FFmpeyPlayer_player(JNIEnv *env, jobject obj, jstring inputStr_,
                                           jobject surface) {
